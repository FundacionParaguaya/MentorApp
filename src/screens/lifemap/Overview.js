      ...
      >
        <View style={[globalStyles.background, styles.contentContainer]}>
          ...
          <View>
            ...
            >
              <View style={styles.listTitle} accessibilityLabel={filterLabel || t('views.lifemap.allIndicators')} accessibilityHint="Double tap to open dropdown">
          ...
          >
            <View style={styles.dropdown} accessible={true} accessibilityLiveRegion="assertive">
              ...
              {/* Green */}
              <View accessibilityLabel={t('views.lifemap.green')}>
                <FilterListItem
                  id="green"
